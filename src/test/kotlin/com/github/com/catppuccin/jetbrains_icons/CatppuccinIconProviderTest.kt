...
import com.github.catppuccin.jetbrains_icons.CatppuccinIconProvider
...
class CatppuccinIconProviderTest : LightJavaCodeInsightFixtureTestCase5() {
  ...
  private fun assertIconProvided(expected: Icon, element: () -> PsiElement) {
    val provider = CatppuccinIconProvider()
